...
subtitle: "Day of Year, Depth, and Future Weather XGBoost Model"
...
dfReduced = select(df, c("depth", "year", "dayofyear", "value", "avg_airTemp_35", 'min_airTemp_35', 'max_airTemp_35', 'avg_radian_35'))
...
# Train our model
bst <- xgboost(data = dtrain, max.depth = 10, eta = 0.1, nthread = 2, nrounds = 30, verbose = 1)
